...
namespace AssemblyCSharp
{
	...
	{
		public string apiKey  = "003ff7eb6844fbc4772b73dc028a8b482422a67989486966d9a56c78ca254587";						// API key that you have receieved after the success of app creation from AppHQ
		public string secretKey = "dd4df4bb64fc5feb1c8f2a958c4aeefd8764a91263732aac1142b36a6507dc34";					// SECRET key that you have receieved after the success of app creation from AppHQ
		public string gameName ="3DSnake";						// Name of the game which you can create from AppHQ console by clicking 
		// Business Service -> Game Service -> Game -> Add Game
		public string description  = "3D snake game";			// Enter your description
		public string userName  = "raimonds"; 				// Name of the user for which you have to save score or create user etc. 
		public string userName1  = "ra002";				// Name of the user for which you have to save score or create user etc.
		public string sessionId  = "<Session Id of the User>";   		// Session id of the user for which you have to have invalidate his session 
		public string emailId  = "raimis0001@gmail.com";    			// EmailId for the user creation
