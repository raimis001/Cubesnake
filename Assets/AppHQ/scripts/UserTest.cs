...
public class GameResponse : App42CallBack
{
	public void OnException(Exception ex)
	{
		Debug.Log("Response error: " + ex.Message);
	}
	...
	public void OnSuccess(object response)
	{
		...
		{
			Debug.LogFormat("{0} score:{1} ID:{2}", game.GetScoreList()[i].GetUserName(), game.GetScoreList()[i].GetValue(), game.GetScoreList()[i].GetScoreId());
...
public class UserTest : MonoBehaviour
{
	...
	GameResponse gameCallback = new GameResponse();
